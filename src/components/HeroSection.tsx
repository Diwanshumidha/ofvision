    ...
    <div className="flex gap-4   flex-col sm:flex-row w-full bg-background justify-center   items-center px-4">
      <div className="">
        <Motion {...OpacityAnimation}>
          <h1 className=" mt-5 font-bold text-lg md:text-2xl  ">
        ...
        <p className=" max-md:hidden text-lg md:text-3xl flex flex-col gap-1 justify-center font-bold  text-background w-max   mt-9">
          <span className="bg-text w-max ">CHOOSE WHAT WORKS </span>
          <span className="bg-text w-max mx-auto ">BEST FOR YOU</span>
        </p>
        <div className=" flex max-md:hidden  gap-3 mt-5">
          {" "}
      ...
      <p className=" text-lg md:text-3xl flex flex-col gap-1 justify-center font-bold  text-background w-max   mt-9">
        <span className="bg-text w-max ">CHOOSE WHAT WORKS </span>
        <span className="bg-text w-max mx-auto ">BEST FOR YOU</span>
      </p>
